...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(/*"/media/all",*/ "/media/notice", "/media/news", "/media/video", "/media/photo", "/media/notice/list", "/media/photo/list", "/media/news/list", "/media/video/list", "/mainTrophy/getTrophy").permitAll()
