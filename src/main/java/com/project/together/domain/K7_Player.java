...
public class K7_Player {
    ...
    private String k7PlayerSubCapYn;
    private String k7PlayerPosition;
    private String k7PlayerHeight; //추가
    private String k7PlayerWeight; //추가
    private String k7PlayerBirth;  //추가
}
